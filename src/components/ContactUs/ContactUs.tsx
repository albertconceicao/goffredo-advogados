    ...
    <Container>
      <Content className='container'>
        <div className='info'>
          ...
          <a className='standard button-web'  href='https://wa.me/5511976716676?text=Olá, desejo saber mais sobre seus serviços de Advocacia que vi pelo site.' target='_blank' rel="noreferrer"><span>Fale comigo pelo WhatsApp </span><img src="./whatsapp.svg" alt="" /></a>
        </div>
        ...
        <a className='standard button-mobile' href='https://wa.me/5511976716676?text=Olá, desejo saber mais sobre seus serviços de Advocacia que vi pelo site.' target='_blank' rel="noreferrer"><span>Fale comigo pelo WhatsApp </span></a>
      </Content>
    </Container>
  );
}
